...
class SaleForm(forms.ModelForm):
    ...
    class Meta:
        model = Sale
        fields = ['day', 'location', 'product', 'customer', 'sale_type', 'quantity_kg', 'quantity_piece', 'unit_price', 'cost_price', 'price', 'amount_paid', 'is_paid', 'payment_date', 'payment_method']
        widgets = {
            ...
            'cost_price': forms.NumberInput(attrs={'class': 'form-control form-control-lg', 'step': '0.01', 'id': 'id_cost_price'}),
